...
const Sijang_detail15 = ({ posts, store }) => {
  return (
    <div className={styles.container}>
      <div className={styles.intro}>
        <img src="pics/marketTitle/jisuTitle.jpg" className={styles.image} />
        <div className={styles.title_star}>
          <div className={styles.title}>지수언니</div>
          <Rating
        ...
        <div className={styles.open_time}>
          ...
          <div className={styles.field}>
            ...
            <div className={styles.use_}>
              <div className={styles.uses_}>오후 12시 - 오후 8시</div>
            </div>
          </div>
        </div>
        <hr />
...
export default Sijang_detail15;
