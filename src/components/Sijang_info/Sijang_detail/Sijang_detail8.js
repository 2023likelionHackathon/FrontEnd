...
const Sijang_detail8 = ({ posts, store }) => {
  return (
    <div className={styles.container}>
      <div className={styles.intro}>
        <img src="pics/marketTitle/mijeongTitle.jpg" className={styles.image} />
        <div className={styles.title_star}>
          <div className={styles.title}>미정이네 코다리찜</div>
          <Rating
        ...
        <div className={styles.menu}>
          ...
          <div className={styles.menu_img_text}>
            <img
              src="pics/marketMenu/mijeongMenu.jpg"
              className={styles.gazami_img}
            />
            <div className={styles.menu_text}>
              <span className={styles.title_menu}>코다리찜</span>
              <div className={styles.price}>24,000원</div>
        ...
        <div className={styles.menus_}>
          ...
          <div className={styles.menu1}>
            <div className={styles.food}>코다리찜</div>
            <div className={styles.line}>
              <img src="pics/Vector39.png" className={styles.line__} />
            </div>
            <div className={styles.price}>24,000원</div>
          ...
          <div className={styles.menu2}>
            <div className={styles.food}>닭볶음탕</div>
          ...
          <div className={styles.menu3}>
            <div className={styles.food}>제육볶음</div>
            <div className={styles.line}>
              <img src="pics/Vector39.png" className={styles.line__} />
            </div>
