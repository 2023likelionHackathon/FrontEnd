...
const Sijang_detail16 = () => {
  return (
    <div className={styles.container}>
      <div className={styles.intro}>
        <img src="pics/marketTitle/tigerTitle.jpg" className={styles.image} />
        <div className={styles.title_star}>
          <div className={styles.title}>호랑이식탁</div>
          <Rating
        ...
        <div className={styles.open_time}>
          ...
          <div className={styles.field}>
            <div className={styles.days}>
              ...
              <div className={`${styles.day} ${styles.rest}`}>break</div>
            </div>
            ...
            <div className={styles.use_}>
              <div className={styles.uses_}>오전 11시반 - 오후 10시</div>
              <div className={styles.uses_}>오전 11시반 - 오후 9시</div>
...
export default Sijang_detail16;
