...
const Sijang_detail14 = ({ posts, store }) => {
  return (
    <div className={styles.container}>
      <div className={styles.intro}>
        <img src="pics/marketTitle/silverTitle.jpg" className={styles.image} />
        <div className={styles.title_star}>
          <div className={styles.title}>은식당</div>
          <Rating
        ...
        <div className={styles.open_time}>
          ...
          <div className={styles.field}>
            ...
            <div className={styles.use_}>
              <div className={styles.uses_}>오전 11시 - 오후 10시</div>
              <div className={styles.uses_}>오전 11시 - 오후 3시</div>
...
export default Sijang_detail14;
