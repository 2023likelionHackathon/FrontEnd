...
const Sijang_detail17 = ({ posts, store }) => {
  return (
    <div className={styles.container}>
      <div className={styles.intro}>
        <img src="pics/marketTitle/hunTitle.jpg" className={styles.image} />
        <div className={styles.title_star}>
          <div className={styles.title}>훈이네</div>
          <Rating
            className={styles.Rating}
            name="star_rating"
            precision={0.2}
            value={styles.score} //임시값임 서버에서  받아와서 들어갈값
            readOnly
...
export default Sijang_detail17;
