...
const Sijang_detail7 = ({ posts, store }) => {
  return (
    <div className={styles.container}>
      <div className={styles.intro}>
        <img src="pics/marketTitle/rakjiTitle.jpg" className={styles.image} />
        <div className={styles.title_star}>
          <div className={styles.title}>락지</div>
          <Rating
        ...
        <div className={styles.open_time}>
          ...
          <div className={styles.field}>
            <div className={styles.days}>
              <div className={styles.day}>월~금</div>
              <div className={styles.day}>토,일</div>
            </div>
            ...
            <div className={styles.use_}>
              ...
              <div className={styles.uses_}>오전 11시 - 오후 11시</div>
            </div>
          </div>
        </div>
        <hr />
        <div className={styles.menu}>
          ...
          <div className={styles.menu_img_text}>
            <img
              src="pics/marketMenu/rakjiMenu.jpg"
              className={styles.gazami_img}
            />
            <div className={styles.menu_text}>
              <span className={styles.title_menu}>낙지요리</span>
        ...
        <div className={styles.menus_}>
          ...
          <div className={styles.menu1}>
            <div className={styles.food}>낙지볶음(1인)</div>
            <div className={styles.line}>
              <img src="pics/Vector39.png" className={styles.line__} />
            </div>
            <div className={styles.price}>13,000원</div>
          </div>
          <div className={styles.menu2}>
            <div className={styles.food}>수제오징어튀김</div>

            <div className={styles.line}>
              <img src="pics/Vector39.png" className={styles.line__} />
            </div>
            <div className={styles.price}>15,000원</div>
          </div>
          <div className={styles.menu3}>
            <div className={styles.food}>낙지해물전</div>
            <div className={styles.line}>
              <img src="pics/Vector39.png" className={styles.line__} />
            </div>
            <div className={styles.price}>15,000원</div>
