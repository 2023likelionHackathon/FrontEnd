...
const Sijang_detail12 = ({ posts, store }) => {
  return (
    <div className={styles.container}>
      <div className={styles.intro}>
        <img src="pics/marketTitle/yeongsuTitle.jpg" className={styles.image} />
        <div className={styles.title_star}>
          <div className={styles.title}>영수분식</div>
          <Rating
...
export default Sijang_detail12;
