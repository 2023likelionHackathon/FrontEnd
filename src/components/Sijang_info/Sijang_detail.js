    ...
    return (
        <div className={styles.container}>
            <div className={styles.intro}>
                <img src="pics/SeongSu_fish.png" className={styles.image} />
                <div className={styles.title}>성수물고기</div>
                <div className={styles.loc}>
                    뚝도시장 | 와인,파스타 <br />
                    서울특별시 성동구 성수동 2가 339-122
                </div>
                <hr />
                <div className={styles.open_time}>
                    ...
                    <div className={styles.field}>
                        ...
                        <div className={styles.lines}>
                            ...
                            <div className={styles.line}><img src='pics/Vector39.png' className={styles.line__} /></div>
                            <div className={styles.line}><img src='pics/Vector39.png' className={styles.line__} /></div>
                            <div className={styles.line}><img src='pics/Vector39.png' className={styles.line__} /></div>
                        </div>
                        <div className={styles.use_}>
                            ...
                            <div className={`${styles.uses_} ${styles.rest}`}>매주 월요일</div>
                        </div>
                    </div>
                </div>
                <hr />
                <div className={styles.menu}>
                    ...
                    <div className={styles.menu_img_text}>
                        ...
                        <div className={styles.menu_text}>
                            ...
                            <span className={styles.title_menu}>
                                크림가자미
                            </span>
